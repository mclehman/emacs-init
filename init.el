...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (matlab-mode htmlize org-bullets auto-org-md babel evil-surround use-package solarized-theme seq racer powerline magit let-alist helm evil-visual-mark-mode evil-leader evil-commentary esup company-anaconda cargo))))
(custom-set-faces
